...
import { ExternalLink, Heart, Dumbbell } from 'lucide-react';
  ...
  const projects = [
    {
      ...
      link: "#",
      github: "https://github.com/Harshkhatri16"
    },
    {
      title: "Gym Bro",
        ...
        <div className="grid lg:grid-cols-2 gap-12">
          {projects.map((project, idx) => (
            <motion.div
              ...
              className="group glass rounded-[2rem] overflow-hidden hover:border-primary/30 transition-all duration-500"
            >
